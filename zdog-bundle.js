(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.ZdogBundle = {}));
	 ...
	 */
	var boilerplate = boilerplate$1.exports;

	var hasRequiredBoilerplate;

	function requireBoilerplate () {
		if (hasRequiredBoilerplate) return boilerplate$1.exports;
		...
		return boilerplate$1.exports;
	}

	var canvasRenderer$1 = {exports: {}};

	/**
	 * CanvasRenderer
	 */
	var canvasRenderer = canvasRenderer$1.exports;

	var hasRequiredCanvasRenderer;

	function requireCanvasRenderer () {
		if (hasRequiredCanvasRenderer) return canvasRenderer$1.exports;
		...
		(function (module) {
			...
			}( canvasRenderer, function factory() {
		...
		return canvasRenderer$1.exports;
	}

	var svgRenderer$1 = {exports: {}};

	/**
	 * SvgRenderer
	 */
	var svgRenderer = svgRenderer$1.exports;

	var hasRequiredSvgRenderer;

	function requireSvgRenderer () {
		if (hasRequiredSvgRenderer) return svgRenderer$1.exports;
		...
		return svgRenderer$1.exports;
	}

	var vector$1 = {exports: {}};

	/**
	 * Vector
	 */
	var vector = vector$1.exports;

	var hasRequiredVector;

	function requireVector () {
		if (hasRequiredVector) return vector$1.exports;
		hasRequiredVector = 1;
		(function (module) {
			( function( root, factory ) {
			  // module definition
		...
		return vector$1.exports;
	}

	var anchor$1 = {exports: {}};

	/**
	 * Anchor
	 */
	var anchor = anchor$1.exports;

	var hasRequiredAnchor;

	function requireAnchor () {
		if (hasRequiredAnchor) return anchor$1.exports;
		hasRequiredAnchor = 1;
		(function (module) {
			( function( root, factory ) {
			  // module definition
			...
			}( anchor, function factory( utils, Vector, CanvasRenderer, SvgRenderer ) {
		...
		return anchor$1.exports;
	}

	var dragger$1 = {exports: {}};

	/**
	 * Dragger
	 */
	var dragger = dragger$1.exports;

	var hasRequiredDragger;

	function requireDragger () {
		if (hasRequiredDragger) return dragger$1.exports;
		...
		return dragger$1.exports;
	}

	var illustration$1 = {exports: {}};

	/**
	 * Illustration
	 */
	var illustration = illustration$1.exports;

	var hasRequiredIllustration;

	function requireIllustration () {
		if (hasRequiredIllustration) return illustration$1.exports;
		...
		(function (module) {
			...
			}( illustration, function factory( utils, Anchor, Dragger ) {
		...
		return illustration$1.exports;
	}

	var pathCommand$1 = {exports: {}};

	/**
	 * PathCommand
	 */
	var pathCommand = pathCommand$1.exports;

	var hasRequiredPathCommand;

	function requirePathCommand () {
		if (hasRequiredPathCommand) return pathCommand$1.exports;
		...
		(function (module) {
			...
			}( pathCommand, function factory( Vector ) {
	 ...
	 * Shape
	 */
	var shape = shape$1.exports;

	var hasRequiredShape;

	function requireShape () {
		if (hasRequiredShape) return shape$1.exports;
		hasRequiredShape = 1;
		(function (module) {
			( function( root, factory ) {
			  // module definition
			...
			}( shape, function factory( utils, Vector, PathCommand, Anchor ) {
	 ...
	 * Group
	 */
	var group = group$1.exports;

	var hasRequiredGroup;

	function requireGroup () {
		if (hasRequiredGroup) return group$1.exports;
		hasRequiredGroup = 1;
		(function (module) {
			( function( root, factory ) {
			  // module definition
	 ...
	 * Rect
	 */
	var rect = rect$1.exports;

	var hasRequiredRect;

	function requireRect () {
		if (hasRequiredRect) return rect$1.exports;
		hasRequiredRect = 1;
		(function (module) {
			( function( root, factory ) {
			  // module definition
		...
		return rect$1.exports;
	}

	var roundedRect$1 = {exports: {}};

	/**
	 * RoundedRect
	 */
	var roundedRect = roundedRect$1.exports;

	var hasRequiredRoundedRect;

	function requireRoundedRect () {
		if (hasRequiredRoundedRect) return roundedRect$1.exports;
		...
		(function (module) {
			...
			}( roundedRect, function factory( Shape ) {
		...
		return roundedRect$1.exports;
	}

	var ellipse$1 = {exports: {}};

	/**
	 * Ellipse
	 */
	var ellipse = ellipse$1.exports;

	var hasRequiredEllipse;

	function requireEllipse () {
		if (hasRequiredEllipse) return ellipse$1.exports;
		...
		(function (module) {
			...
			}( ellipse, function factory( Shape ) {
		...
		return ellipse$1.exports;
	}

	var polygon$1 = {exports: {}};

	/**
	 * Shape
	 */
	var polygon = polygon$1.exports;

	var hasRequiredPolygon;

	function requirePolygon () {
		if (hasRequiredPolygon) return polygon$1.exports;
		...
		(function (module) {
			...
			}( polygon, function factory( utils, Shape ) {
		...
		return polygon$1.exports;
	}

	var hemisphere$1 = {exports: {}};

	/**
	 * Hemisphere composite shape
	 */
	var hemisphere = hemisphere$1.exports;

	var hasRequiredHemisphere;

	function requireHemisphere () {
		if (hasRequiredHemisphere) return hemisphere$1.exports;
		...
		(function (module) {
			...
			}( hemisphere, function factory( utils, Vector, Anchor, Ellipse ) {
		...
		return hemisphere$1.exports;
	}

	var cylinder$1 = {exports: {}};

	/**
	 * Cylinder composite shape
	 */
	var cylinder = cylinder$1.exports;

	var hasRequiredCylinder;

	function requireCylinder () {
		if (hasRequiredCylinder) return cylinder$1.exports;
		...
		(function (module) {
			...
			}( cylinder, function factory( utils, PathCommand, Shape, Group, Ellipse ) {
	 ...
	 */
	var cone = cone$1.exports;

	var hasRequiredCone;

	function requireCone () {
		if (hasRequiredCone) return cone$1.exports;
		hasRequiredCone = 1;
		(function (module) {
			( function( root, factory ) {
			  // module definition
			...
			}( cone, function factory( utils, Vector, PathCommand, Anchor, Ellipse ) {
	 ...
	 * Box composite shape
	 */
	var box = box$1.exports;

	var hasRequiredBox;

	function requireBox () {
		if (hasRequiredBox) return box$1.exports;
		hasRequiredBox = 1;
		(function (module) {
			( function( root, factory ) {
			  // module definition
			...
			}( box, function factory( utils, Anchor, Shape, Rect ) {
	...
	function requireJs () {
		if (hasRequiredJs) return js$1.exports;
		hasRequiredJs = 1;
		(function (module) {
			( function( root, factory ) {
			  // module definition
			...
			} )( js, function factory( Zdog, CanvasRenderer, SvgRenderer, Vector, Anchor,
	...
	var Zdog = /*#__PURE__*/_mergeNamespaces({
		__proto__: null,
		default: index
	}, [jsExports]);

	const { Illustration, Ellipse, Rect, Anchor } = Zdog;

	function createZdogScene(canvas, options = {}) {
	...
	exports.Rect = Rect;
	exports.createZdogScene = createZdogScene;

}));
//# sourceMappingURL=zdog-bundle.js.map
