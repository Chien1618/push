(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.MyOGL = {}));
    ...
    // helper variables
    const vertex$7 = /* @__PURE__ */ new Vec3();
...
`;
    ...
    class AxesHelper extends Mesh {
        constructor(
            ...
            const program = new Program(gl, { vertex: vertex$3, fragment: fragment$3 });
...
`;
    ...
    var OGLCore = /*#__PURE__*/Object.freeze({
        __proto__: null,
        Geometry: Geometry,
        Program: Program,
        Renderer: Renderer,
    ...
    // Toàn bộ thư viện OGL sẽ được gói trong thuộc tính 'Core' của global bundle.
    // Ví dụ: window.MyOGL.Core.Renderer, window.MyOGL.Core.Camera, etc.
    const Core = OGLCore;
...
//# sourceMappingURL=ogl.framer.js.map
